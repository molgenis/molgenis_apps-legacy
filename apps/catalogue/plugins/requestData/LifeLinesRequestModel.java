...
/**
 * LifeLinesRequestModel takes care of all state and it can have helper methods
...
public class LifeLinesRequestModel extends EasyPluginModel
{
	...
	// this string can be referenced from LifeLinesRequestView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from LifeLinesRequestView.ftl template as
	// ${model.date}
