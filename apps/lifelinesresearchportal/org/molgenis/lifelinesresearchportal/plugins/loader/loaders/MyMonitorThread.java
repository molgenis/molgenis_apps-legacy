		...
		try
		{
			do
			{
				log.info(String.format(
						"[monitor-%s] [%d/%d] Active: %d, Completed: %d, Task: %d, isShutdown: %s, isTerminated: %s",
						this.tableName, this.executor.getPoolSize(), this.executor.getCorePoolSize(),
			...
			log.info(String.format(
					"[monitor-s] [%s/%d] Active: %d, Completed: %d, Task: %d, isShutdown: %s, isTerminated: %s",
					this.tableName, this.executor.getPoolSize(), this.executor.getCorePoolSize(),
					this.executor.getActiveCount(), this.executor.getCompletedTaskCount(),
					this.executor.getTaskCount(), this.executor.isShutdown(), this.executor.isTerminated()));
