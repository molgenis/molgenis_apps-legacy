...
public class LuceneConfiguration
{
	...
	public String GetLuceneConfiguration(String param)
	{
		...
		File argh = new File(this.getClass().getResource("LuceneIndexConfiguration.bbmri.properties").getFile()
				.replace("%20", " "));
		 ...
		 * File("LuceneIndexConfiguration.properties").getAbsolutePath()));
		...
		if (param == "LUCENE_INDEX_DIRECTORY") return LUCENE_INDEX_DIRECTORY = configFile
				.getProperty("lucene_index_directory");
		if (param == "LUCENE_ONTOINDEX_DIRECTORY") return LUCENE_ONTOINDEX_DIRECTORY = configFile
				.getProperty("lucene_ontocat_index_directory");
		if (param == "ONTOLOGIES_DIRECTORY") return ONTOLOGIES_DIRECTORY = configFile
				.getProperty("ontologies_directory");
