...
public class Header extends org.molgenis.mutation.ui.header.Header
{
	...
	public Header(String name, ScreenController<?> parent)
	{
		...
		this.getModel()
				.setTitle(
						"International Microvillus Inclusion Disease (MVID) Patient Registry<br><font size=\"-1\">International registry of patients with microvillus inclusion disease and database of associated MYO5B mutations</font>");
	}
