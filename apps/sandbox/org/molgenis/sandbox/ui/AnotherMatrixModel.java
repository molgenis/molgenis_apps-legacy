...
/**
 * AnotherMatrixModel takes care of all state and it can have helper methods to
...
public class AnotherMatrixModel extends EasyPluginModel
{
	...
	// this string can be referenced from AnotherMatrixView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from AnotherMatrixView.ftl template as
	// ${model.date}
