...
/**
 * InputsTestModel takes care of all state and it can have helper methods to
...
public class InputsTestModel extends EasyPluginModel
{
	...
	// this string can be referenced from InputsTestView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from InputsTestView.ftl template as
	// ${model.date}
