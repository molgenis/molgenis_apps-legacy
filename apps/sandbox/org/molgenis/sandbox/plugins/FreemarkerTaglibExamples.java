...
/**
 * FreemarkerTaglibExamplesController takes care of all user requests and
 * application logic.
 * 
 * <li>Each user request is handled by its own method based action=methodName.
 * <li>MOLGENIS takes care of db.commits and catches exceptions to show to the
 * user <li>FreemarkerTaglibExamplesModel holds application state and business
 * logic on top of domain model. Get it via this.getModel()/setModel(..) <li>
 * FreemarkerTaglibExamplesView holds the template to show the layout. Get/set
 * it via this.getView()/setView(..).
 */
public class FreemarkerTaglibExamples extends EasyPluginController<FreemarkerTaglibExamplesModel>
{
	...
	{
		super(name, parent);
		this.setModel(new FreemarkerTaglibExamplesModel(this)); // the default
																// model
	}
