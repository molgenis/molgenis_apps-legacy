 ...
 * accordingly (in MVC architecture).
 * 
 * <li>TestModel holds application state and services on top of domain model <li>
 * TestView are template/scripts to show the layout.
 */
public class Test extends EasyPluginController<TestModel>
{
	...
	/**
	 * Reload data if needed into model and change view if needed. Exceptions
	 * will be caught, logged and shown to the user. All db actions are within
	 * one transaction.
	 * 
