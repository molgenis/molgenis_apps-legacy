...
/**
 * TestThreeModel takes care of all state and it can have helper methods to
...
public class TestThreeModel extends EasyPluginModel
{
	...
	// this string can be referenced from TestThreeView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from TestThreeView.ftl template as
	// ${model.date}
