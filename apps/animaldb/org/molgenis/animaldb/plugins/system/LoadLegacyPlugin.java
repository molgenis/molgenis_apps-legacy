...
public class LoadLegacyPlugin extends PluginModel<Entity>
{
	...
	public void handleRequest(Database db, Tuple request)
	{
		try
		{
			...
			// ConvertUliDbToPheno myLoadUliDb = new ConvertUliDbToPheno(db,
			// this.getLogin());
			...
			// //String filename =
			// "C:/Documents and Settings/Administrator/workspace/molgenis_apps/data/AnimalDB/legacy/20110429_UliEisel/Tierdetails.csv";
			// ConvertUliDbToPheno myLoadUliDb = new ConvertUliDbToPheno(db,
			// this.getLogin());
			...
			// cs.setDatabase(db);
			// cs.makeObservationTargetNameMap(this.getLogin().getUserName(),
			// true);
			// }
			//
