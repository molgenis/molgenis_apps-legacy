...
public class PrintLabelPlugin extends EasyPluginController
{
	 ...
	 */
	private void handlePrintRequest(Database db, Tuple request) throws LabelGeneratorException, DatabaseException,
			ParseException, MatrixException
	{
	 ...
	 * @throws MatrixException
	 */
	private List<ObservationTarget> getIndividualsFromUi(Database db, Tuple request) throws DatabaseException,
			ParseException, MatrixException
	{
