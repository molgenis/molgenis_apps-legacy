...
public class Breeding extends PluginModel<Entity>
{
	...
	public void handleRequest(Database db, Tuple request)
	{
		...
		try
		{
			if (motherMatrixViewer != null && action.startsWith(motherMatrixViewer.getName()))
			{
				...
				this.action = "createParentgroup"; // return to mother selection
													// screen
				return;
			}
			...
			if (action.equals("addParentgroupScreen4"))
			{
				...
				{
					this.action = "addParentgroupScreen3"; // stay in current
															// screen
			...
			if (action.equals("addParentgroup"))
			{
				...
				this.setSuccess("Parentgroup " + newPgName + " successfully added; adding filter to matrix: name = "
						+ newPgName);
			}
	...
	private int Genotype(Database db, Tuple request) throws Exception
	{
		...
		// Date genoDate =
		// newDateOnlyFormat.parse(request.getString("genodate"));
