 ...
 */
public class BreedingSuggestion extends PluginModel<Entity>
{
	...
	public BreedingSuggestion(String name, ScreenController<?> parent)
	{
		super(name, parent);
	}
	...
	public void handleRequest(Database db, MolgenisRequest request)
	{
		...
		try
		{
			...
			if (action.equals("reqInfo"))
			{
				...
				info = "<h2>Animal " + animalName + "</h2>" + "is from litter: " + litterName + "<br />"
						+ "which came from parentgroup: " + parentgroupName + "<br />" + "with mother(s): " + mothers
						+ "<br />" + "and father(s): " + fathers + "<br />" + "and with sibling(s): " + siblings;
			}
		}
		catch (Exception e)
		{
