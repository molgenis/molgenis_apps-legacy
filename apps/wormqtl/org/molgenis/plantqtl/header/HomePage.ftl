<#macro org_molgenis_plantqtl_header_HomePage screen>
...
<div align="center">
	<table width="700px">
		...
		<tr>
			<td colspan="4" align="center">
				<div align="left">
					<h2>PlantQTL - Public archive and analysis web portal for natural variation data in plants.</h2>
					PlantQTL is an online scalable system for QTL exploration to service the plant community. PlantQTL provides many publicly available datasets and welcomes submissions from other plant researchers.
				</div>
			</td>
		</tr>
		<tr>
