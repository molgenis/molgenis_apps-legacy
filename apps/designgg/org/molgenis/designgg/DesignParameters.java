...
public class DesignParameters extends AbstractEntity
{
	...
	// Tab delimited data with genotypes as markers (rows) and individuals
	// (cols)
	...
	/**
	 * Get the Tab delimited data with genotypes as markers (rows) and
	 * individuals (cols).
	 * 
	 * @return genotype.
	 */
	...
	/**
	 * Set the Tab delimited data with genotypes as markers (rows) and
	 * individuals (cols).
	 * 
	 * @param _genotype
	 */
	...
	/**
	 * Genotype is a pointer to a file. getGenotypeAttachedFile() can be used to
	 * retrieve this file.
	 */
	...
	/**
	 * Genotype is a pointer to a file. Use setGenotypeAttachedFile() to attach
	 * this file so it can be retrieved using getGenotypeAttachedFile().
	 */
	...
	public Object get(String name)
	{
		...
		if (name.equals("twocolorarray")) return getTwoColorArray();
		if (name.equals("genotype")) return getGenotype();
		if (name.equals("factor1active")) return getFactor1active();
		if (name.equals("factor2active")) return getFactor2active();
		if (name.equals("factor3active")) return getFactor3active();
		if (name.equals("factor1label")) return getFactor1Label();
		if (name.equals("factor2label")) return getFactor2Label();
		if (name.equals("factor3label")) return getFactor3Label();
		if (name.equals("factor1level")) return getFactor1Level();
		if (name.equals("factor2level")) return getFactor2Level();
		if (name.equals("factor3level")) return getFactor3Level();
		if (name.equals("norilsperlevel")) return getNoRilsPerLevel();
		if (name.equals("noslides")) return getNoSlides();
		if (name.equals("noiterations")) return getNoIterations();
		return "";
	}
	...
	{
		return "DesignParameters(" + "twocolorarray='" + getTwoColorArray() + "' " + "genotype='" + getGenotype()
				+ "' " + "factor1active='" + getFactor1active() + "' " + "factor2active='" + getFactor2active() + "' "
				+ "factor3active='" + getFactor3active() + "' " + "factor1label='" + getFactor1Label() + "' "
				+ "factor2label='" + getFactor2Label() + "' " + "factor3label='" + getFactor3Label() + "' "
				+ "factor1level='" + getFactor1Level() + "' " + "factor2level='" + getFactor2Level() + "' "
				+ "factor3level='" + getFactor3Level() + "' " + "norilsperlevel='" + getNoRilsPerLevel() + "' "
				+ "noslides='" + getNoSlides() + "'" + "noiterations='" + getNoIterations() + "'" + ");";
	}

	@Override
	public boolean equals(Object other)
	{
		if (!DesignParameters.class.equals(other.getClass())) return false;
		DesignParameters e = (DesignParameters) other;

		if (getTwoColorArray() == null ? e.getTwoColorArray() != null : !getTwoColorArray()
				.equals(e.getTwoColorArray())) return false;
		if (getGenotype() == null ? e.getGenotype() != null : !getGenotype().equals(e.getGenotype())) return false;
		if (getFactor1active() == null ? e.getFactor1active() != null : !getFactor1active()
				.equals(e.getFactor1active())) return false;
		if (getFactor2active() == null ? e.getFactor2active() != null : !getFactor2active()
				.equals(e.getFactor2active())) return false;
		if (getFactor3active() == null ? e.getFactor3active() != null : !getFactor3active()
				.equals(e.getFactor3active())) return false;
		if (getFactor1Label() == null ? e.getFactor1Label() != null : !getFactor1Label().equals(e.getFactor1Label())) return false;
		if (getFactor2Label() == null ? e.getFactor2Label() != null : !getFactor2Label().equals(e.getFactor2Label())) return false;
		if (getFactor3Label() == null ? e.getFactor3Label() != null : !getFactor3Label().equals(e.getFactor3Label())) return false;
		if (getFactor1Level() == null ? e.getFactor1Level() != null : !getFactor1Level().equals(e.getFactor1Level())) return false;
		if (getFactor2Level() == null ? e.getFactor2Level() != null : !getFactor2Level().equals(e.getFactor2Level())) return false;
		if (getFactor3Level() == null ? e.getFactor3Level() != null : !getFactor3Level().equals(e.getFactor3Level())) return false;
		if (getNoRilsPerLevel() == null ? e.getNoRilsPerLevel() != null : !getNoRilsPerLevel().equals(
				e.getNoRilsPerLevel())) return false;
		if (getNoSlides() == null ? e.getNoSlides() != null : !getNoSlides().equals(e.getNoSlides())) return false;
		if (getNoIterations() == null ? e.getNoIterations() != null : !getNoIterations().equals(e.getNoIterations())) return false;
	...
	{
		return ("" + "twocolorarray" + sep + "genotype" + sep + "factor1active" + sep + "factor2active" + sep
				+ "factor3active" + sep + "factor1label" + sep + "factor2label" + sep + "factor3label" + sep
				+ "factor1level" + sep + "factor2level" + sep + "factor3level" + sep + "norilsperlevel" + sep
				+ "noslides" + sep + "noiterations");
	}
