...
public class Stat
{
	...
	{
		return String
				.format("Stat(n=%s, nulls=%s, invalid_values=%s, special_values=%s, mean=%s, mean_count=%s, sd=%s, median=%s, median_count=%s, min=%s, min_count=%s, max=%s, max_count=%s)",
						n, nulls, invalid_values, special_values, mean, mean_count, sd, median, median_count, min,
