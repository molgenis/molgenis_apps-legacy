...
/**
 * EbiHeaderModel takes care of all state and it can have helper methods to
...
public class EbiStyleLoaderModel extends EasyPluginModel
{
	...
	// this string can be referenced from EbiHeaderView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from EbiHeaderView.ftl template as
	// ${model.date}
