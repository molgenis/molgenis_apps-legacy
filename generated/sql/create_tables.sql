	...
	DROP TABLE HemoSampleGroup IF EXISTS CASCADE;
	CREATE CACHED TABLE HemoSampleGroup (
		id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL	
		, name VARCHAR(255)	
		, PRIMARY KEY(id)
		, UNIQUE(name)
	...
	CREATE CACHED TABLE SNP_Polymorphism (
		...
		ALTER TABLE HemoSample ADD FOREIGN KEY (SampleGroup) REFERENCES HemoSampleGroup (id) ON DELETE RESTRICT;
