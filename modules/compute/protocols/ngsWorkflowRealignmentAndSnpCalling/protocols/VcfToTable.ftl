...
getFile ${snpsfinalvcf}

getFile ${vcf2tablepy}
getFile ${snpannotationstatspl}
...
putFile ${snpsfinalvcftable}
putFile ${snpsfinalvcftabletype}
putFile ${snpsfinalvcftableclass}
putFile ${snpsfinalvcftableimpact}