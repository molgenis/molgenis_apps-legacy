...
public class SysCommandExecutor
{
	...
	{
		if (fEnvironmentVarList == null) fEnvironmentVarList = new ArrayList();
	...
	private Process runCommandHelper(String commandLine) throws IOException
	{
		...
		if (fWorkingDirectory == null) process = Runtime.getRuntime().exec(commandLine, getEnvTokens());
		else
	...
	{
		if (fEnvironmentVarList == null) return null;
