...
/**
 * Created by IntelliJ IDEA. User: georgebyelas Date: 07/11/2011 Time: 14:31 To
...
public class ClusterScript extends Script
{
	...
	{
		String command;
		if (this.isShort()) command = RemoteScriptSubmitter.SUB_SHORT + this.getRemoteDir() + this.getRemotename();
		else
