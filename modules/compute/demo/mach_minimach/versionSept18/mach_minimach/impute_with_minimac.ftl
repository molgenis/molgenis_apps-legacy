...
#The imputation step
${minimacBin} --vcfReference --refHaps ${referencePanel} --haps ${preparedStudyDir}/chr${chr}.gz --snps ${preparedStudyDir}/chr${chr}.snps --rounds 5 --states 200 --prefix ${preparedStudyDir}/chr${chr}.results
