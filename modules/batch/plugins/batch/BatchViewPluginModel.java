...
/**
 * BatchViewPluginModel takes care of all state and it can have helper methods
...
public class BatchViewPluginModel extends EasyPluginModel
{
	...
	// this string can be referenced from BatchViewPluginView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from BatchViewPluginView.ftl template as
	// ${model.date}
