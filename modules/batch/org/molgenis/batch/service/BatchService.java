...
public class BatchService
{
	...
	public List<MolgenisBatchEntity> getBatchEntities(Database db, int batchId) throws DatabaseException,
			ParseException
	{
	 ...
	 */
	public List<ObservationTarget> getObservationTargetsNotInBatch(Database db) throws DatabaseException,
			ParseException
	{
		...
		{
			List<MolgenisBatchEntity> l = db.query(MolgenisBatchEntity.class)
					.equals(MolgenisBatchEntity.OBJECTID, target.getId()).find();
			if (l.size() == 0)
			{
				result.add(target);
			}
	 ...
	 * 
	 * @param batchId
	 *            : the id of the batch to test for
	 * @return
	 * @throws DatabaseException
	 * @throws ParseException
	 */
	...
	public void removeFromBatch(Database db, Integer batchId, List<Integer> entityIds) throws DatabaseException,
			IOException
	{
	...
	public void addToBatch(Database db, Integer batchId, List<Integer> targetIds) throws DatabaseException,
			ParseException, IOException
	{
		for (Integer targetId : targetIds)
		{
			 ...
			 * db.query(OntologyTerm.class).equals(OntologyTerm.NAME,
			 * target.getClass().toString()).find();
			 */
	...
	// public String getTargetLabel(int targetId) throws DatabaseException,
	// ParseException {
