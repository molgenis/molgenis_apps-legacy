...
public class Col7a1Contact extends Contact
{
	...
	public Col7a1Contact(String name, ScreenController<?> parent)
	{
		...
		this.getModel()
				.setText(
						"If you have any comments, questions or suggestions to improve the DEB patient registry, please do not hesitate to contact us. Please enter your name, a valid email address and your message and press \"submit\". We will reply shortly.");
	}
