...
public class DataSetViewerPluginTest
{
	...
	{
		DataSetViewerPlugin plugin = new DataSetViewerPlugin("DataSet", null);
		...
		httpServletRequest.getSession().setAttribute("selectedObservableFeatures", selectedObservableFeatures);
