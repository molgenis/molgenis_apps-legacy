...
public class DatabaseSearch_XqtlTestNG
{
	...
	public void doSearch() throws Exception
	{
		...
		// NOTE THAT: Formula is specific for Metabolite, while Description is
		// common for ObservationElement
		Metabolite hydroxy = db
				.find(Metabolite.class, new QueryRule(Metabolite.NAME, Operator.EQUALS, "Hydroxypropyl")).get(0);
		...
		// Search 1: Find a subclass-specific attribute using search() on the
		// subclass type
		...
		// Search 2: Find a subclass-specific attribute using search() on the
		// superclass type
		...
		// Search 4: Find a common attribute using search() on the superclass
		// type
