...
public class PedMapParser
{
	...
	private String parseMap(String mapFilePath, String dir) throws IOException
	{
		...
		String line;
		int index = 0;
		while ((line = in.readLine()) != null && index < 496) // bad! but other
																// file is
																// chopped up
		{
	...
	private void parsePed(String pedFilePath, String dir, String markerNames) throws IOException
	{
		...
		while ((line = in.readLine()) != null)
		{
			...
			addToFile(individuals, "Ind" + splitTab[1] + "\t" + splitTab[0] + "\t" + "Ind" + splitTab[2] + "\t" + "Ind"
					+ splitTab[3]);
	...
	{
		new PedMapParser("D:/data/xgapdata/HumanPublicSets/193sgenome_sample.ped",
				"D:/data/xgapdata/HumanPublicSets/193sgenome.map");
