...
/**
 * UploadSampleReportModel takes care of all state and it can have helper
...
public class UploadSampleReportModel extends EasyPluginModel
{
	...
	// this string can be referenced from UploadSampleReportView.ftl template as
	// ${model.helloWorld}
	public String helloWorld = "hello World";
	// this date can be referenced from UploadSampleReportView.ftl template as
	// ${model.date}
