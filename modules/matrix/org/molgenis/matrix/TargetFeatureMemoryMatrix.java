...
public class TargetFeatureMemoryMatrix extends PhenoMemoryMatrix<ObservationTarget, ObservableFeature> implements
		TargetFeatureMatrix, EditableMatrix<ObservationTarget, ObservableFeature, ObservedValue>,
		FilterableMatrix<ObservationTarget, ObservableFeature, ObservedValue>
{

	public TargetFeatureMemoryMatrix(Class<ObservationTarget> rowType, Class<ObservableFeature> colType, Database db)
	...
	public void setCol(int col, List<ObservedValue> colValues) throws MatrixException
	{
		...
		if (col >= getColCount()) throw new MatrixException("setCol failed: col >= getColCount()");
	...
	public void setRow(int row, List<ObservedValue> rowValues) throws MatrixException
	{
		...
		if (row >= getRowCount()) throw new MatrixException("setRow failed: row >= getRowCount()");
	...
	public TargetFeatureMemoryMatrix getSubMatrixFilterByColMatrixValues(QueryRule q)
	{
		// TODO Auto-generated method stub
		return null;
	}

	public TargetFeatureMemoryMatrix getSubMatrixFilterByRowMatrixValues(QueryRule q)
	{
		// TODO Auto-generated method stub
		return null;
	}
