...
/**
 * Convenience class for defining MatrixQueryRule.Type.colHeader Here you need
 * both column AND value.property
 */
public class MatrixRowValueFilter extends MatrixQueryRule
{
	 ...
	 * 
	 * @param colIndex
	 *            the index of the column this value filter applies to
	 * @param colProperty
	 *            the property of the value this filter applies to
	 * @param operator
	 *            the operator
	 */
	 ...
	 *            colum index
	 * @param property
	 *            property of the value. E.g. 'protocolApplication'
	 * @param operator
	 * @param value
	 */
