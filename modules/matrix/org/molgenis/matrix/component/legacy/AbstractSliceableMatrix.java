...
public abstract class AbstractSliceableMatrix<R, C, V> implements SliceableMatrix<R, C, V>
{
	...
	private <T> void sliceByIndex(List<T> indices, List<Integer> indicesCopy, List<Integer> resultIndices,
			List<T> resultC, Operator operator, int index) throws Exception
	{
