...
/**
 * Tells the Matrix browser what to render. We leave it up to the user to
 * construct or manipulate RenderableMatrix.
 * 
...
public interface RenderableMatrix<R, C, V> extends BasicMatrix<R, C, V>, SourceMatrix<R, C, V>
{
	...
	/**
	 * The list of filters that was applied to reach the currently rendered
	 * matrix.
	 */
	...
	/**
	 * Show the stepsize on the screen. This is the number of cells, or 'speed'
	 * with which the matrix moves when move (panning) actions are performed.
	 */
