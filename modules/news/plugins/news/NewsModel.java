...
/**
 * NewsModel takes care of all state and it can have helper methods to query the
 * database. It should not contain layout or application logic which are solved
 * in View and Controller.
 * 
...
public class NewsModel extends SimpleScreenModel
{
	...
	// this string can be referenced from NewsView.ftl template as
	// ${model.helloWorld}
