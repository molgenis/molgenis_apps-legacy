...
public class WorksheetHelper
{
	...
	//
	// /**
	// * Default convertor. Assumes the worksheet is build up based on Lane
	// only.
	// *
	// * @param worksheet
	// * @param sampleList
	...
	// * @throws Exception
	// */
	// public void convertTuplesToEntites(List<Tuple> worksheet, List<NgsSample>
	// sampleList, List<LibraryLane> laneList, List<Trio> trioList)
	// throws Exception
	// {
