...
public class QueryParametersDTO implements Serializable
{
	...
	public String printSearchOptions()
	{
		...
		if (StringUtils.isNotEmpty(this.mutationName)) result.add("variation = '" + this.mutationName + "'");
		if (StringUtils.isNotEmpty(this.mutationPosition)) result.add("nucleotide number = '" + this.mutationPosition
				+ "'");
		if (StringUtils.isNotEmpty(this.mutationType)) result.add("mutation type = '" + this.mutationType + "'");
		if (StringUtils.isNotEmpty(this.aaNo)) result.add("amino acid number = '" + this.aaNo + "'");
		if (StringUtils.isNotEmpty(this.exonNumber)) result.add("exon/intron = '" + this.exonNumber + "'");
		if (StringUtils.isNotEmpty(this.searchTerm)) result.add("search term = '" + this.searchTerm + "'");
